# LRI Database Curation for Benchmarking
...
Created a mapping of potential gene product subunits that pertain to
each cytokine specific to CytoSig
...
- Remove instances where feature references itself to prevent bias of
